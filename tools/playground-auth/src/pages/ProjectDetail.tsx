...
const PROJECT_DATA: Record<string, { name: string; description: string; tasks: { id: string; title: string; status: string; priority: string }[] }> = {
    "orion-launch": {
        name: "Orion Launch",
        ...
        tasks: [
            ...
            { id: "t_orion_2", title: "Wire production analytics events", status: "in_progress", priority: "urgent" },
            { id: "t_orion_3", title: "QA sign-off on checkout flow", status: "todo", priority: "high" },
            { id: "t_orion_4", title: "Update landing page copy", status: "todo", priority: "normal" },
        ],
    },
    "atlas-migration": {
        ...
        tasks: [
            ...
            { id: "t_atlas_2", title: "Dry-run on staging", status: "in_progress", priority: "urgent" },
    ...
    "helix-redesign": {
        ...
        tasks: [
            ...
            { id: "t_helix_2", title: "Component library update", status: "in_progress", priority: "high" },
        ],
    },
};
        ...
        <div className="app-shell" data-testid="project-detail-page">
            ...
            <main className="main-content">
                <div className="page-header">
                    <div style={{ fontSize: ".8rem", color: "var(--muted)", marginBottom: ".25rem" }}>
                                ...
                                <tr key={t.id} data-testid={`task-row-${t.id}`}>
                                    ...
                                    <td>
                                        <select
                                            ...
                                            style={{ fontSize: ".8rem", border: "1px solid var(--border)", borderRadius: "var(--radius)", padding: ".2rem .4rem" }}
                                        >
                                    ...
                                    <td>
                                        <span className={`badge badge-${t.priority === "urgent" ? "urgent" : t.priority === "high" ? "in-progress" : "todo"}`}>
                                            {t.priority}
                                        </span>
                                    </td>
                                </tr>
