...
export const PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        category: "audio",
        priceCents: 4999,
        // BUG B9: should be out of stock (0), shows 3 in stock.
        stock: 3,
    ...
    },
    {
        ...
        category: "input",
        // BUG B1: price should be $59.00 (5900), displays $49.00.
        priceCents: 4900,
        stock: 12,
...
export const COUPONS: Record<string, { label: string; percentOff: number }> = {
    // BUG B4: WELCOME10 should be 10% off, applies only 5%.
    WELCOME10: { label: "Welcome discount", percentOff: 5 },
};
