...
|--------------|---------|-------------|---------------|
| Cookie consent | First visit | `localStorage` (`playground-tasks-cookie-consent`) | `cookie-consent-banner`, `cookie-consent-accept`, `cookie-consent-decline` |
...
pnpm exec nx run @raiken/playground-tasks:serve

# Type-check and production build
pnpm exec nx run @raiken/playground-tasks:typecheck
pnpm exec nx run @raiken/playground-tasks:build

# Golden Playwright suite (starts Vite automatically)
pnpm exec nx run @raiken/playground-tasks:test:e2e
...
pnpm exec nx run @raiken/playground-tasks:auth-wall
```
